    ...
    def seed(self) -> None:
        ...
        seeded_claims = [
            Claim(
                ...
                approved_reason="Historical claim approved and paid after standard review.",
            ...
            Claim(
                ...
                status=ClaimStatus.COMPLETED,
                approved_reason="Historical claim approved based on repair evidence.",
            ...
            Claim(
                ...
                status=ClaimStatus.COMPLETED,
                approved_reason="Historical claim approved after policy and evidence validation.",
